...
retry budget is global today, which means one slow marketplace can consume the
whole budget and stall the others.

> Open question: should the retry budget be per-marketplace instead of global?
